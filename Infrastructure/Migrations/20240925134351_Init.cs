        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailAddress = table.Column<string>(type: "varchar(324)", maxLength: 324, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "varchar(324)", maxLength: 324, nullable: false),
                    HashedPassword = table.Column<string>(type: "varchar(max)", nullable: false),
                    Username = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("b48703e5-2bc4-4996-88dd-4369d76fd61d"), null, new DateTime(2024, 9, 25, 20, 43, 50, 385, DateTimeKind.Local).AddTicks(2393), new DateTime(2003, 11, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "sohardz01@gmail.com", "Nguyễn", "8EB5FCCE783BD03A51C31E46C8DC5C14AF3B88368E3A90C7CEF94FDF2754F84E:195F202C46A617CCA98EBEDF5FCB021C:50000:SHA256", "default-profile.png", false, "Cương", 1, "admin" });

            migrationBuilder.InsertData(
                table: "StaffRoles",
                columns: new[] { "Id", "RoleId", "StaffId" },
                values: new object[] { new Guid("2f544640-04c1-47b2-a5e5-fb45eb1b46bb"), new Guid("0fc1d27c-f6c4-4011-8d3c-4d33b2703369"), new Guid("b48703e5-2bc4-4996-88dd-4369d76fd61d") });
