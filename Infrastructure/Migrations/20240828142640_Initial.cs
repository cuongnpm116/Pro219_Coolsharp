        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailAddress = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: false),
                    Username = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    HashedPassword = table.Column<string>(type: "varchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProvinceCode = table.Column<string>(type: "char(2)", nullable: false),
                    DistrictCode = table.Column<string>(type: "char(3)", nullable: false),
                    WardCode = table.Column<string>(type: "char(5)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipAddressDetail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhoneNumber = table.Column<string>(type: "varchar(15)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0fc1d27c-f6c4-4011-8d3c-4d33b2703369"), "admin", "Quản trị viên" },
                    { new Guid("5f266f3f-bfda-4a21-bd55-c3191249bea5"), "staff", "Nhân viên" }
                });

            migrationBuilder.InsertData(
                table: "Staffs",
                columns: new[] { "Id", "CreateBy", "CreatedOn", "DateOfBirth", "DeletedBy", "DeletedOn", "Email", "FirstName", "HashedPassword", "ImageUrl", "IsDeleted", "LastName", "Username" },
                values: new object[] { new Guid("b48703e5-2bc4-4996-88dd-4369d76fd61d"), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2003, 11, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "sohardz01@gmail.com", "Nguyễn", "AB0272B5633D704E2A9AA32DB02BD75E8CC533D179E614B085652354806FB9E0:159C2CCABBF75EDBE691EA3775078FC4:50000:SHA256", "default.png", false, "Cương", "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_EmailAddress_Username",
                table: "Customers",
                columns: new[] { "EmailAddress", "Username" },
                unique: true);
