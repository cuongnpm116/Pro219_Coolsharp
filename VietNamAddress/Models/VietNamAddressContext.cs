...
public partial class VietNamAddressContext : DbContext
{
    public VietNamAddressContext()
    {
    }

    public VietNamAddressContext(DbContextOptions<VietNamAddressContext> options)
        : base(options)
    {
    }
